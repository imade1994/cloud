...
public class RetOps<T> {
	 ...
	 * @throws Ex 断言失败时抛出
	 */
	public <Ex extends Exception> RetOps<T> assertSuccess(Function<? super CloudResult<T>, ? extends Ex> func) throws Ex {
	 ...
	 * @throws Ex 断言失败时抛出
	 */
	public <Ex extends Exception> RetOps<T> assertDataNotNull(Function<? super CloudResult<T>, ? extends Ex> func) throws Ex {
	 ...
	 * @throws Ex 断言失败时抛出
	 */
	public <Ex extends Exception> RetOps<T> assertDataNotEmpty(Function<? super CloudResult<T>, ? extends Ex> func) throws Ex {
	...
	public <U> RetOps<U> map(Function<? super T, ? extends U> mapper) {
		CloudResult<U> result = CloudResult.restResult(mapper.apply(original.getData()), original.getCode(), original.getDesc());
		return of(result);
	}
