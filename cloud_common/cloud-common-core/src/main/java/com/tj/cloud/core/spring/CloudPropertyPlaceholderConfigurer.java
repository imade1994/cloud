...
/**
 * * @Author codingMan_tj
 * * @Date 2024/3/26 12:02
 * * @version v1.0.0
 * * @desc 自定义环境配置 配置文件加解密
 **/
public class CloudPropertyPlaceholderConfigurer extends PropertyPlaceholderConfigurer implements IProperty, EnvironmentAware {
