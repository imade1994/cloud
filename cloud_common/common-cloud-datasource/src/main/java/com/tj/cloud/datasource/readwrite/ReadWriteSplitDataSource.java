...
public class ReadWriteSplitDataSource extends AbstractDataSource implements AutoCloseable{
    ...
    public ReadWriteSplitDataSource(DataSource primary, List<DataSource> replicates, ReplicaLoadBalanceAlgorithm loadBalanceAlgorithm) {
    ...
    private DataSource getDataSource() {
        return ObjectUtils.isEmpty(replicates) || !ReadWriteSplitHolder.isReadOnly() ? primary : loadBalanceAlgorithm.choice(replicates);
    }
