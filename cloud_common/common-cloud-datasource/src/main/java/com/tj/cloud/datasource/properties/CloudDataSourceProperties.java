...
public class CloudDataSourceProperties {
     ...
     *
     * <ul>
     *      <ol>ROUND_ROBIN: Round-robin replica load-balance algorithm.</ol>
     *      <ol>RANDOM: Random replica load-balance algorithm.</ol>
     * </ul>
     */
    ...
    public Class<?> getReplicaLoadBalanceAlgorithmClass() {
        return replicaLoadBalanceAlgorithmClass != null ? replicaLoadBalanceAlgorithmClass : replicaLoadBalanceAlgorithm.loadClass();
    }
}
