...
import com.tj.cloud.uid.utils.PaddedAtomicLong;
...
/**
 * * @Author codingMan_tj * @Date 2024/4/1 14:11 * @version v1.0.0 * @desc
 **/
public class RingBuffer {
	...
	public long take() {
		...
		// Note that: Step 2,3 can not swap. If we set flag before get value of slot, the
		// producer may overwrite the
	...
	public String toString() {
		return "RingBuffer [bufferSize=" + bufferSize + ", tail=" + tail + ", cursor=" + cursor + ", paddingThreshold="
				+ paddingThreshold + "]";
	}
