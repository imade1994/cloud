package com.tj.cloud.uid.impl;

import com.tj.cloud.uid.BitsAllocator;
import com.tj.cloud.uid.buffer.BufferPaddingExecutor;
import com.tj.cloud.uid.buffer.RejectedPutBufferHandler;
import com.tj.cloud.uid.buffer.RejectedTakeBufferHandler;
import com.tj.cloud.uid.buffer.RingBuffer;
...
/**
 * * @Author codingMan_tj * @Date 2024/4/1 13:42 * @version v1.0.0 * @desc 缓存的uid 实现
 **/
