...
/**
 * * @Author codingMan_tj * @Date 2024/3/25 15:46 * @version v1.0.0 * @desc J2Cache 对于
 * 抽象ICache 的实现
 **/
public class J2CacheImpl<T extends Object> implements ICache<T> {
	...
	public List<T> findBySimpleKeys(String key) {
		...
		CopyOnWriteArrayList<String> keys = (CopyOnWriteArrayList<String>) cacheChannel
				.keys(J2CacheConstant.DEFAULT_REGION);
