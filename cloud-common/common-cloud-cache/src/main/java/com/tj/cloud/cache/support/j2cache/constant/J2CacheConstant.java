package com.tj.cloud.cache.support.j2cache.constant;

/**
 * * @Author codingMan_tj * @Date 2024/3/25 15:45 * @version v1.0.0 * @desc 缓存常量
 **/
public class J2CacheConstant {
	...
	/**
	 * redis message container bean id
	 */
	public static final String HL_REDIS_MESSAGE_CONTAINER_BEAN_ID = "hlRedisMessageContainer";
