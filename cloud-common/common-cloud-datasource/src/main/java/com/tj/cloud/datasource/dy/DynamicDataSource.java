...
/**
 * * @Author codingMan_tj * @Date 2024/3/28 11:31 * @version v1.0.0 * @desc
 **/
public class DynamicDataSource extends AbstractRoutingDataSource {
	...
	public void addDataSource(String key, Object dataSource) {
		try {
			Map<Object, Object> targetDataSources = (Map<Object, Object>) getValue(this,
					DataSourceUtil.TARGET_DATA_SOURCES);
	...
	public void removeDataSource(String key) {
		Map<Object, Object> targetDataSources = (Map<Object, Object>) getValue(this,
				DataSourceUtil.TARGET_DATA_SOURCES);
		if (!targetDataSources.containsKey(key) || key.equals(DataSourceUtil.GLOBAL_DATASOURCE)
				|| key.equals(DataSourceUtil.DEFAULT_DATASOURCE)) {
			return;
		}
	...
	public Map<String, DataSource> getDataSource() {
		Map<String, DataSource> targetDataSources = (Map<String, DataSource>) getValue(this,
				DataSourceUtil.TARGET_DATA_SOURCES);
