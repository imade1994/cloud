...
/**
 * * @Author codingMan_tj * @Date 2024/3/28 11:13 * @version v1.0.0 * @desc
 **/
public class RwTransactionInterceptor extends TransactionInterceptor {
	...
	@Override
	protected Object invokeWithinTransaction(@NonNull Method method, Class<?> targetClass,
			@NonNull InvocationCallback invocation) throws Throwable {
