...
/**
 * * @Author codingMan_tj * @Date 2024/3/26 13:07 * @version v1.0.0 * @desc 类装载工具
 **/
public class AppUtil implements ApplicationContextAware {
	 ...
	 */
	@Override
	public void setApplicationContext(@NonNull ApplicationContext _context) throws BeansException {
		context = _context;
