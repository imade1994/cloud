...
import com.tj.cloud.auth.support.handler.SsoLogoutSuccessHandler;
import org.springframework.security.config.annotation.web.builders.HttpSecurity;
import org.springframework.security.config.annotation.web.configurers.AbstractHttpConfigurer;

/**
 * * @Author codingMan_tj * @Date 2024/4/7 10:25 * @version v1.0.0 * @desc
 **/
public class FormIdentityLoginConfigurer extends AbstractHttpConfigurer<FormIdentityLoginConfigurer, HttpSecurity> {
	...
	public void init(HttpSecurity http) throws Exception {
		...
		}).logout(logout -> logout.logoutSuccessHandler(new SsoLogoutSuccessHandler()).deleteCookies("JSESSIONID")
