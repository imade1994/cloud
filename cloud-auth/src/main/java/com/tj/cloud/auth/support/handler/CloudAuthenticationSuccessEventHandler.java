...
public class CloudAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {
    ...
    private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new CloudCustomOAuth2AccessTokenResponseHttpMessageConverter();
